...
namespace aves.Droid
{
    ...
    public class MainActivity : Activity
    {
        ...
        void FnBindMenu()
        {
            ...
            int[] strMnuUrl = { Resource.Drawable.ic_menu_equipo, Resource.Drawable.ic_menu_recomendacion, Resource.Drawable.ic_menu_tipo, Resource.Drawable.ic_menu_morfologia, Resource.Drawable.ic_menu_habitats, Resource.Drawable.ic_menu_sonido };
